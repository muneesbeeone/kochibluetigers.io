<div id="Sponsors" class="rts-sponsors-section section-gap component">
    <div class="container">
        <div class="section-title-area section-title-area1 text-center mb--50">
            ...
            <p>Our hype squad, who pushes us to hit it big, both on and off the field.</p>
        </div>
        ...
        <div class="sponsors-section-inner" style="text-align: center;display: flex;justify-content: center;margin-top: 50px;">
            <a href="/contact-us" class="more-btn" style="width: fit-content;">BECOME A SPONSOR <i class="fal fa-long-arrow-right"></i></a>
        </div>
    </div>
</div>