    ...
    <div class="container">
        <div class="top-wrap">
            ...
            <div class="filter-button-group">
                <button onclick="window.location.href='/gallary'" class="filter-btn" style="color: aliceblue;font-weight: 200">VIEW MORE<i class="fal fa-long-arrow-right"></i></button>
            ...
            <div class="gallery-grid">
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="item">
                            <span class="gallery-picture"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
